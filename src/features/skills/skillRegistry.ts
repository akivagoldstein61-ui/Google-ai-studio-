...
export const SKILLS: SkillDefinition[] = [
  defineSkill({
    ...
    skillId: 'kesher-personality-assessment',
    title: 'Personality Assessment',
    shortTitle: 'Assessment',
    subtitle: 'Kesher Reflection Administration',
    icon: Brain,
    color: 'bg-violet-100 text-violet-700 border-violet-200',
    status: 'live',
    dataStatus: 'live',
    category: 'personality',
    description: 'Original Kesher reflection questionnaire with deterministic private domain/aspect scoring and bilingual owner-only reporting.',
    keyFeatures: ['20 original Kesher reflection items', 'Reverse-keyed items with deterministic scoring', 'Private report saved only after completion', 'No LLM scoring, raw public scores, or compatibility verdicts'],
  ...
  defineSkill({
    ...
    dataStatus: 'live',
    category: 'personality',
    description: 'Translates the deterministic Kesher private report into warm reflection cards via local fallback or structured Gemini output. Owner-only by default.',
    keyFeatures: ['Domain and aspect cards in the member language', 'AI receives derived private-report fields only', 'No clinical labels, fixed identities, or match claims', 'Export, reset, and delete controls remain visible'],
  ...
  defineSkill({
    ...
    shortTitle: 'Engine',
    subtitle: 'Kesher Scoring & Reflection Pipeline',
    icon: Cpu,
    color: 'bg-violet-100 text-violet-700 border-violet-200',
    status: 'prototype',
    category: 'personality',
    description: 'Kesher assessment system covering test administration, deterministic scoring, private reports, pair reflections, and personality-aware explanation guardrails.',
    keyFeatures: ['Deterministic scoring with no LLM scoring', 'Structured output schemas for reflections', 'Versioned Kesher item bank', 'Bilingual Hebrew and English reflection copy'],
  ...
  defineSkill({
    ...
    dataStatus: 'live',
    category: 'personality',
    description: 'Kesher personality domain reflection integrated with Jewish observance layers and Hebrew-first localization for culturally aware reflection cards.',
    keyFeatures: ['Kesher domains mapped to dating-relevant reflection', 'Observance-layer signals stay separate from personality', 'Hebrew-first with RTL layout support', 'Cultural context in reflection cards'],
    primarySurface: 'profile-builder',
    entryPoints: [
