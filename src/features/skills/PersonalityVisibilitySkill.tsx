...
const FIELD_MATRIX: Array<{
  ...
  { field: 'Kesher domain reflection card', public: false, private: true, mutual: false, system: false },
  ...
  { field: 'Raw Kesher reflection answers', public: false, private: false, mutual: false, system: true },
